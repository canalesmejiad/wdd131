document.addEventListener("DOMContentLoaded", () => {
    ...
    const temples = [
        ...
        {
            templeName: "Rome Italy", location: "Rome, Italy", dedicated: "2019, March, 10", area: 41000,
            imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/rome-italy-temple/rome-italy-temple-2642-main.jpg"
        },
        {
            templeName: "Laie Hawaii", location: "Laie, Hawaii, United States", dedicated: "1919, November, 27", area: 42100,
            imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/laie-hawaii-temple/laie-hawaii-temple-7370-main.jpg"
        },
        {
            templeName: "Tokyo Japan", location: "Tokyo, Japan", dedicated: "1980, October, 27", area: 52590,
    ...
    const makeImg = (t) => {
        ...
        img.addEventListener("error", () => {
            ...
            img.alt = `${t.templeName} (image unavailable)`;
        });
        return img;
    };
    ...
    const setTitle = (txt) => { if (viewTitle) viewTitle.textContent = txt; };
    ...
    const setActive = (btn) => {
        document.querySelectorAll(".seg-item").forEach(b => b.classList.remove("is-active"));
        if (btn) {
    ...
    if (homeBtn) homeBtn.addEventListener("click", (e) => { setActive(e.currentTarget); setTitle("Home"); displayTemples(temples); });
    if (oldBtn) oldBtn.addEventListener("click", (e) => { setActive(e.currentTarget); setTitle("Old Temples"); displayTemples(temples.filter(t => parseYear(t.dedicated) < 1900)); });
    if (newBtn) newBtn.addEventListener("click", (e) => { setActive(e.currentTarget); setTitle("New Temples"); displayTemples(temples.filter(t => parseYear(t.dedicated) > 2000)); });
    if (largeBtn) largeBtn.addEventListener("click", (e) => { setActive(e.currentTarget); setTitle("Large Temples"); displayTemples(temples.filter(t => t.area > 90000)); });
    if (smallBtn) smallBtn.addEventListener("click", (e) => { setActive(e.currentTarget); setTitle("Small Temples"); displayTemples(temples.filter(t => t.area < 10000)); });
